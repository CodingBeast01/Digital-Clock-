...
public class Psdude extends JPanel implements Runnable
		{
			Thread thread;
			int i,j,k,p=0,q=0;
			String year,month,day,second,mintue,hour;
...
private void clockLayout(Graphics g) {
		...
		mintue = String.valueOf(calender.get(Calendar.MINUTE));
		...
		g.setColor(Color.black);
				...
				g.fillRect(810,470,80,50);
							...
							g.drawString(mintue+ "M",725,505);
							g.drawString(second+ "S",825,505);
							
							
				//hanger layout
				g.setColor(Color.black);
				g.fillOval(740,154,10,10);
				g.fillOval(698,213,10,10);
				g.fillOval(808,213,10,10);
				g.drawLine(753,160,700,200);
		...
		//String Written Text
		g.setColor(Color.blue);
		g.drawString("Clock Design By Kritiman Singh" , 300,100);
		g.drawString("            Gmail -  " , 110,150);
		g.setColor(Color.black);
		g.setFont(new Font (" TimeRoman" , Font.BOLD, 35));
		g.drawString("   kritimansingh123@gmail.com ", 300,150);
						...
						g.drawString("1" ,xOrigin+70 ,yOrigin - 112);
